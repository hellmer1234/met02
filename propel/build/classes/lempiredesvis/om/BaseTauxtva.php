 ...
 */
abstract class BaseTauxtva extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'TauxtvaPeer';
    ...
    /**
     * The value for the libelletaux field.
     * @var        string
     */
    protected $libelletaux;

    /**
     * The value for the tauxtva field.
     * @var        double
     */
    protected $tauxtva;
    ...
    /**
     * Get the [libelletaux] column value.
     * Libelle du taux de TVA
     * @return string
     */
    public function getLibelletaux()
    {

        return $this->libelletaux;
    }

    /**
     * Get the [tauxtva] column value.
     * Taux de la TVA
     * @return double
     */
     ...
     * @return Tauxtva The current object (for fluent API support)
     */
    public function setIdtaux($v)
    {
        ...
        if ($this->idtaux !== $v) {
            $this->idtaux = $v;
            $this->modifiedColumns[] = TauxtvaPeer::IDTAUX;
        }
    ...
    /**
     * Set the value of [libelletaux] column.
     * Libelle du taux de TVA
     * @param  string $v new value
     * @return Tauxtva The current object (for fluent API support)
     */
    public function setLibelletaux($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->libelletaux !== $v) {
            $this->libelletaux = $v;
            $this->modifiedColumns[] = TauxtvaPeer::LIBELLETAUX;
        }
    ...
    /**
     * Set the value of [tauxtva] column.
     * Taux de la TVA
    ...
    public function setTauxtva($v)
    {
        ...
        if ($this->tauxtva !== $v) {
            $this->tauxtva = $v;
            $this->modifiedColumns[] = TauxtvaPeer::TAUXTVA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idtaux = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->libelletaux = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->tauxtva = ($row[$startcol + 2] !== null) ? (double) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = TauxtvaPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Tauxtva object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TauxtvaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TauxtvaQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TauxtvaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TauxtvaPeer::IDTAUX)) {
            $modifiedColumns[':p' . $index++]  = 'idtaux';
        }
        if ($this->isColumnModified(TauxtvaPeer::LIBELLETAUX)) {
            $modifiedColumns[':p' . $index++]  = 'libelletaux';
        }
        if ($this->isColumnModified(TauxtvaPeer::TAUXTVA)) {
            $modifiedColumns[':p' . $index++]  = 'tauxtva';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'idtaux':
                        ...
                        break;
                    case 'libelletaux':
                        $stmt->bindValue($identifier, $this->libelletaux, PDO::PARAM_STR);
                        break;
                    case 'tauxtva':
                        $stmt->bindValue($identifier, $this->tauxtva, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TauxtvaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TauxtvaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Tauxtva'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Tauxtva'][$this->getPrimaryKey()] = true;
        $keys = TauxtvaPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdtaux(),
            $keys[1] => $this->getLibelletaux(),
            $keys[2] => $this->getTauxtva(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdtaux($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setLibelletaux($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setTauxtva($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TauxtvaPeer::IDTAUX)) $criteria->add(TauxtvaPeer::IDTAUX, $this->idtaux);
        if ($this->isColumnModified(TauxtvaPeer::LIBELLETAUX)) $criteria->add(TauxtvaPeer::LIBELLETAUX, $this->libelletaux);
        if ($this->isColumnModified(TauxtvaPeer::TAUXTVA)) $criteria->add(TauxtvaPeer::TAUXTVA, $this->tauxtva);
    ...
    {
        $criteria = new Criteria(TauxtvaPeer::DATABASE_NAME);
        $criteria->add(TauxtvaPeer::IDTAUX, $this->idtaux);
    ...
    {
        $copyObj->setLibelletaux($this->getLibelletaux());
     ...
     * If this Tauxtva is new, it will return
    ...
    {
        return (string) $this->exportTo(TauxtvaPeer::DEFAULT_STRING_FORMAT);
    }
