...
abstract class BasePromotionPeer
{
    ...
    const IDPROMO = 'promotion.idpromo';

    /** the column name for the titrepromo field */
    const TITREPROMO = 'promotion.titrepromo';

    /** the column name for the datedebut field */
    const DATEDEBUT = 'promotion.datedebut';

    /** the column name for the datefin field */
    const DATEFIN = 'promotion.datefin';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identity map to hold any loaded instances of Promotion objects.
     ...
     * e.g. PromotionPeer::$fieldNames[PromotionPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idpromo', 'Titrepromo', 'Datedebut', 'Datefin', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idpromo', 'titrepromo', 'datedebut', 'datefin', ),
        BasePeer::TYPE_COLNAME => array (PromotionPeer::IDPROMO, PromotionPeer::TITREPROMO, PromotionPeer::DATEDEBUT, PromotionPeer::DATEFIN, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDPROMO', 'TITREPROMO', 'DATEDEBUT', 'DATEFIN', ),
        BasePeer::TYPE_FIELDNAME => array ('idpromo', 'titrepromo', 'datedebut', 'datefin', ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. PromotionPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idpromo' => 0, 'Titrepromo' => 1, 'Datedebut' => 2, 'Datefin' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idpromo' => 0, 'titrepromo' => 1, 'datedebut' => 2, 'datefin' => 3, ),
        BasePeer::TYPE_COLNAME => array (PromotionPeer::IDPROMO => 0, PromotionPeer::TITREPROMO => 1, PromotionPeer::DATEDEBUT => 2, PromotionPeer::DATEFIN => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDPROMO' => 0, 'TITREPROMO' => 1, 'DATEDEBUT' => 2, 'DATEFIN' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('idpromo' => 0, 'titrepromo' => 1, 'datedebut' => 2, 'datefin' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    {
        $toNames = PromotionPeer::getFieldNames($toType);
        $key = isset(PromotionPeer::$fieldKeys[$fromType][$name]) ? PromotionPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(PromotionPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, PromotionPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return PromotionPeer::$fieldNames[$type];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PromotionPeer::IDPROMO);
            $criteria->addSelectColumn(PromotionPeer::TITREPROMO);
            $criteria->addSelectColumn(PromotionPeer::DATEDEBUT);
            $criteria->addSelectColumn(PromotionPeer::DATEFIN);
        } else {
            $criteria->addSelectColumn($alias . '.idpromo');
            $criteria->addSelectColumn($alias . '.titrepromo');
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(PromotionPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(PromotionPeer::DATABASE_NAME);
     ...
     *
     * @param Promotion $obj A Promotion object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = (string) $obj->getIdpromo();
            } // if key === null
            PromotionPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(PromotionPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(PromotionPeer::$instances[$key])) {
                return PromotionPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (PromotionPeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        PromotionPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(PromotionPeer::DATABASE_NAME)->getTable(PromotionPeer::TABLE_NAME);
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(PromotionPeer::IDPROMO) && $criteria->keyContainsValue(PromotionPeer::IDPROMO) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(PromotionPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(PromotionPeer::IDPROMO);
            $value = $criteria->remove(PromotionPeer::IDPROMO);
            if ($value) {
                $selectCriteria->add(PromotionPeer::IDPROMO, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(PromotionPeer::IDPROMO, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(PromotionPeer::DATABASE_NAME);
        $criteria->add(PromotionPeer::IDPROMO, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(PromotionPeer::DATABASE_NAME);
            $criteria->add(PromotionPeer::IDPROMO, $pks, Criteria::IN);
