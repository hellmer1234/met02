...
abstract class BaseCatalogue extends BaseObject implements Persistent
{
    ...
    public function setIdarticle($v)
    {
        ...
        if ($this->idarticle !== $v) {
            $this->idarticle = $v;
            $this->modifiedColumns[] = CataloguePeer::IDARTICLE;
        }
    ...
    public function setIdcategorie($v)
    {
        ...
        if ($this->idcategorie !== $v) {
            $this->idcategorie = $v;
            $this->modifiedColumns[] = CataloguePeer::IDCATEGORIE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idcategorie = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = CataloguePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCategorie !== null && $this->idcategorie !== $this->aCategorie->getIdcategorie()) {
            $this->aCategorie = null;
        }
    } // ensureConsistency
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CatalogueQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CataloguePeer::IDARTICLE)) {
            $modifiedColumns[':p' . $index++]  = 'idarticle';
        }
        if ($this->isColumnModified(CataloguePeer::IDCATEGORIE)) {
            $modifiedColumns[':p' . $index++]  = 'idcategorie';
        }

        $sql = sprintf(
            'INSERT INTO catalogue (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['Catalogue'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Catalogue'][serialize($this->getPrimaryKey())] = true;
        $keys = CataloguePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdarticle(),
            $keys[1] => $this->getIdcategorie(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setIdcategorie($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CataloguePeer::IDARTICLE)) $criteria->add(CataloguePeer::IDARTICLE, $this->idarticle);
        if ($this->isColumnModified(CataloguePeer::IDCATEGORIE)) $criteria->add(CataloguePeer::IDCATEGORIE, $this->idcategorie);
    ...
    {
        $criteria = new Criteria(CataloguePeer::DATABASE_NAME);
        $criteria->add(CataloguePeer::IDARTICLE, $this->idarticle);
        $criteria->add(CataloguePeer::IDCATEGORIE, $this->idcategorie);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getIdarticle()) && (null === $this->getIdcategorie());
    }
    ...
    {
        if ($this->aCategorie === null && ($this->idcategorie !== null) && $doQuery) {
            $this->aCategorie = CategorieQuery::create()->findPk($this->idcategorie, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCategorie->addCatalogues($this);
             */
        }
    ...
    public function getArticle(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aArticle === null && ($this->idarticle !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aArticle->addCatalogues($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CataloguePeer::DEFAULT_STRING_FORMAT);
    }
