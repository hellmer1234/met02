...
abstract class BaseCommandePeer
{
    ...
    const ETATCOMMANDE = 'commande.etatcommande';

    /** the column name for the idclient field */
    const IDCLIENT = 'commande.idclient';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identity map to hold any loaded instances of Commande objects.
     ...
     * e.g. CommandePeer::$fieldNames[CommandePeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idcommande', 'Etatcommande', 'Idclient', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idcommande', 'etatcommande', 'idclient', ),
        BasePeer::TYPE_COLNAME => array (CommandePeer::IDCOMMANDE, CommandePeer::ETATCOMMANDE, CommandePeer::IDCLIENT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDCOMMANDE', 'ETATCOMMANDE', 'IDCLIENT', ),
        BasePeer::TYPE_FIELDNAME => array ('idcommande', 'etatcommande', 'idclient', ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. CommandePeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idcommande' => 0, 'Etatcommande' => 1, 'Idclient' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idcommande' => 0, 'etatcommande' => 1, 'idclient' => 2, ),
        BasePeer::TYPE_COLNAME => array (CommandePeer::IDCOMMANDE => 0, CommandePeer::ETATCOMMANDE => 1, CommandePeer::IDCLIENT => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDCOMMANDE' => 0, 'ETATCOMMANDE' => 1, 'IDCLIENT' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('idcommande' => 0, 'etatcommande' => 1, 'idclient' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    {
        $toNames = CommandePeer::getFieldNames($toType);
        $key = isset(CommandePeer::$fieldKeys[$fromType][$name]) ? CommandePeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(CommandePeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, CommandePeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return CommandePeer::$fieldNames[$type];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CommandePeer::IDCOMMANDE);
            $criteria->addSelectColumn(CommandePeer::ETATCOMMANDE);
            $criteria->addSelectColumn(CommandePeer::IDCLIENT);
        } else {
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(CommandePeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(CommandePeer::DATABASE_NAME);
     ...
     *
     * @param Commande $obj A Commande object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = (string) $obj->getIdcommande();
            } // if key === null
            CommandePeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Commande) {
                $key = (string) $value->getIdcommande();
            ...
            unset(CommandePeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(CommandePeer::$instances[$key])) {
                return CommandePeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (CommandePeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        CommandePeer::$instances = array();
    }
    ...
    {
        $key = CommandePeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = CommandePeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + CommandePeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = CommandePeer::OM_CLASS;
            $obj = new $cls();
    ...
    public static function doCountJoinClient(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommandePeer::IDCLIENT, ClientPeer::IDCLIENT, $join_behavior);
    ...
    public static function doSelectJoinClient(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommandePeer::addSelectColumns($criteria);
        $startcol = CommandePeer::NUM_HYDRATE_COLUMNS;
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CommandePeer::addSelectColumns($criteria);
        $startcol2 = CommandePeer::NUM_HYDRATE_COLUMNS;
    ...
    {
        return Propel::getDatabaseMap(CommandePeer::DATABASE_NAME)->getTable(CommandePeer::TABLE_NAME);
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(CommandePeer::IDCOMMANDE) && $criteria->keyContainsValue(CommandePeer::IDCOMMANDE) ) {
    ...
    /**
     * Performs an UPDATE on the database, given a Commande or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(CommandePeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(CommandePeer::IDCOMMANDE);
            $value = $criteria->remove(CommandePeer::IDCOMMANDE);
            if ($value) {
                $selectCriteria->add(CommandePeer::IDCOMMANDE, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(CommandePeer::TABLE_NAME);
            }
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(CommandePeer::TABLE_NAME, $con, CommandePeer::DATABASE_NAME);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(CommandePeer::IDCOMMANDE, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(CommandePeer::DATABASE_NAME);
        $criteria->add(CommandePeer::IDCOMMANDE, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(CommandePeer::DATABASE_NAME);
            $criteria->add(CommandePeer::IDCOMMANDE, $pks, Criteria::IN);
