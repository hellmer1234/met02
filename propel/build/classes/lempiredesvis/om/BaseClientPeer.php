...
abstract class BaseClientPeer
{
    ...
    /** the column name for the numtelephone field */
    const NUMTELEPHONE = 'client.numtelephone';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idclient', 'Login', 'Mdp', 'Nom', 'Prenom', 'Numtelephone', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idclient', 'login', 'mdp', 'nom', 'prenom', 'numtelephone', ),
        BasePeer::TYPE_COLNAME => array (ClientPeer::IDCLIENT, ClientPeer::LOGIN, ClientPeer::MDP, ClientPeer::NOM, ClientPeer::PRENOM, ClientPeer::NUMTELEPHONE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDCLIENT', 'LOGIN', 'MDP', 'NOM', 'PRENOM', 'NUMTELEPHONE', ),
        BasePeer::TYPE_FIELDNAME => array ('idclient', 'login', 'mdp', 'nom', 'prenom', 'numtelephone', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idclient' => 0, 'Login' => 1, 'Mdp' => 2, 'Nom' => 3, 'Prenom' => 4, 'Numtelephone' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idclient' => 0, 'login' => 1, 'mdp' => 2, 'nom' => 3, 'prenom' => 4, 'numtelephone' => 5, ),
        BasePeer::TYPE_COLNAME => array (ClientPeer::IDCLIENT => 0, ClientPeer::LOGIN => 1, ClientPeer::MDP => 2, ClientPeer::NOM => 3, ClientPeer::PRENOM => 4, ClientPeer::NUMTELEPHONE => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDCLIENT' => 0, 'LOGIN' => 1, 'MDP' => 2, 'NOM' => 3, 'PRENOM' => 4, 'NUMTELEPHONE' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('idclient' => 0, 'login' => 1, 'mdp' => 2, 'nom' => 3, 'prenom' => 4, 'numtelephone' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ClientPeer::MDP);
            $criteria->addSelectColumn(ClientPeer::NOM);
            $criteria->addSelectColumn(ClientPeer::PRENOM);
            $criteria->addSelectColumn(ClientPeer::NUMTELEPHONE);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.numtelephone');
        }
    }
